<?php 
  ...
  $query_fetch = "SELECT * from list_employee where id='$employee_id'";
  ...
  if (isset($_POST['submit'])) {
    ...
    $age = $_POST['age'];
    mysqli_query($db,"update list_employee set firstname='$fname', lastname='$lname', contact_no='$number', address='$address', age='$age' where id='$employee_id' ");
  }
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <form method="post">
              <div class="row">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1"  value="<?php echo $id1;?>" disabled>
                    </div>
                </div>                                                            
                <div class="form-group">
                    <div class="col-lg-12">
                    <label for="exampleInputEmail1">First name</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $fname;?>" name="fname" required="">
                    </div>
                </div>
                <div class="form-group">
                  <div class="col-lg-12">
                    <label for="exampleInputPassword1">Last name</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" value="<?php echo $lname;?>"  name="lname" required>
                  </div>  
                </div>
                ...
                <div class="form-group">
                  <div class="col-lg-12">
                    ...
                    <input type="tel" class="form-control" id="phone" value="<?php echo $num;?>"  name="phone" required>
                    </div>
                </div>
                <div class="form-group">
                  <div class="col-lg-12">
                ...
                <div class="form-group">
                    ...
                    <input type="radio" name="gender" value="Male" required="">Male</input>&nbsp&nbsp&nbsp
